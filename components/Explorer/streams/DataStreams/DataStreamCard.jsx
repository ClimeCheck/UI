    ...
    <Link href={`/explore/map/${continent}`}>
      <div className="bg-slate-300 rounded-md p-5 min-w-[250px] group hover:bg-secondary/40">
        <div className="flex justify-between w-full h-full items-center">
          <p className="text-secondary text-sm font-bold p-3 group-hover:text-white">
            {continent}
          </p>
        ...
        <div>
          <div className="mt-2">
            <h1 className="text-3xl font-bold text-secondary group-hover:text-primary">
              {totalDevices}
            </h1>
        ...
        <div className="flex flex-row w-full justify-between items-center h-full mt-5">
          <div className="self-center text-sm group-hover:text-white">

          ...
          {Approach.map((data, key) => {
            return (
              <div className="grid sm:flex" key={key}>
                <h1 className="sm:pr-8 text-xl relative sm:border-r-4 sm:border-r-[#0069B3] text-primary w-[300px]">
                  {data.title}
                </h1>
                <span className="rounded-full bg-[#00963F] -ml-8 sm:mx-[286px] flex p-3 absolute">
                  {" "}
                </span>
